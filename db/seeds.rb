...
breakfast_smoothie = Drink.create!(
  ...
  description: "Whizz up a low-fat breakfast smoothie in no time. Use banana
  with other soft fruit, plus honey for a little sweetness and oats for
  slow-release fuel.",
  steps: "Put all the ingredients in a blender and whizz for 1 min until smooth.
  Pour the mixture into two glasses to serve.",
...
breakfast_smoothie.ingredients.create!(description: "80g soft fruit (like mango
                                       or strawberries")
...
kale_smoothie = Drink.create!(
  ...
  description: "Give yourself a dose of vitamin C in the morning with this vegan
  green smoothie. Along with kale and avocado, there's a hit of zesty lime and
  pineapple.",
  steps: "Put all of the ingredients into a bullet or smoothie maker, add a
  large splash of water and blitz. Add more water until you have the desired
  consistency.",
...
kale_smoothie.ingredients.create!(description: "large handful frozen pineapple
                                  chunks")
